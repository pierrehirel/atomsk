...
WRITE(*,*) "    ou à cette adresse : http://pierrehirel.info/codes/atomsk/"
WRITE(*,*) ""
!
!
...
CASE(1)
  ...
  msg = "\o/ Le programme s'est bien terminé !"
  CALL DISPLAY_MSG(verbosity,msg,logfile)
  WRITE(temp,*) nwarn
  temp = ADJUSTL(temp)
  WRITE(temp2,*) nerr
  temp2 = ADJUSTL(temp2)
  WRITE(msg,*) "   Alertes : "//TRIM(temp)//" ; Erreurs : "//TRIM(temp2)
  CALL DISPLAY_MSG(verbosity,msg,logfile)
  !
CASE(2)
...
CASE(2118)
  ...
  CALL DISPLAY_MSG(verbosity,msg,logfile)
CASE(2119)
  msg = "..> Le système a été re-centré."
  CALL DISPLAY_MSG(verbosity,msg,logfile)
CASE(2120)
...
CASE(4023)
  ...
  CALL DISPLAY_MSG(verbosity,msg,logfile)
  msg = "ls                 Affiche la liste des fichiers du dossier courant"
  CALL DISPLAY_MSG(verbosity,msg,logfile)
...
CASE(4050)
  ...
  msg = ">>> Écriture de tous les fichiers dans "//TRIM(strings(1))// &
...
CASE(4818)
  !strings(1) = file format (e.g. "xyz", "cfg"...)
  msg = "X!X ERREUR : la liste de fichiers dans "//TRIM(strings(1))//" semble vide."
  CALL DISPLAY_MSG(1,msg,logfile)
CASE(4819)
  msg = "X!X ERREUR : les vecteurs de base ne sont pas orthogonaux, abandon."
  CALL DISPLAY_MSG(1,msg,logfile)
CASE(4820)
