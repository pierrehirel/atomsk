...
!* Last modification: J. Barthel - 17 July 2015                                   *
!**********************************************************************************
...
READ(30,*,ERR=200,END=200) i, a, b, c, alpha, beta, gamma ! cell dimensions
...
DO i=1, NP
  ...
  IF( P(i,4)<=0.d0 ) THEN
    ...
    CALL ATOMNUMBER(species,P(i,4))
  ENDIF
  ! convert the biso value from nm**2 to A**2
  AUX(i,biso) = 1.0d2*sbiso
ENDDO
!
!
200 CONTINUE
