...
# then it is expanded to form a 40x20x4 supercell,
...
atomsk --create fcc 4.02 Al orient [0-11] [100] [011] -e 40 20 4 -select in box 0 BOX-4 0  20 BOX BOX -cut above -INF X -select in box BOX-20 BOX-4 0  BOX BOX BOX -cut above -INF x  al_supercell.xyz cfg xsf lmp
